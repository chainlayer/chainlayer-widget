<template>
    <div class="terraLedger" style="width: 300px; display:inline-block; vertical-align:top">
        <img src="/img/logo-terra.svg" alt="Terra" title="Terra" style="height:46px"><br>
        ...
        <a class="button sg-popup-id-143 button_size_2 button_dark button_js" href=""><span class="button_label">Details</span></a-->&nbsp;
